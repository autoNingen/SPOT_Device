...
const char* sasToken = "SharedAccessSignature sr=mySpotHub.azure-devices.net%2Fdevices%2Fesp32-c6-gateway&sig=vLaVfgEIXBOPFIxeVL4GddXOi4lmRQ1FHGU0sJyoAIo%3D&se=1763593490";
...
void sendTelemetry() {
    ...
    String payload = "{\"Device IDs\": \"[1, 2, 3]\": \"Device Values: \": " + v1 + v2 + v3 + ", \"status\": \"ok\"}";
